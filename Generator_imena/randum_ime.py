...
lista_imena = ("Minjole", "drvar")     # lista zeljenih reci
lista_imena_sporedna = ("topologicar", "sekac pica")  # druga lista
...
class Imena:   # klasa 
   ...
   def generator(self):
      ...
      self.ime_jedan = random.choice(lista_imena)     # bira nasumicno ime iz liste ime
